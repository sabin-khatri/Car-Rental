      ...
      >
        <div>
          <div className="space-y-6 max-w-xl mx-auto">
            ...
            >
              Book and Manage Your Rentals on the Go
            </h1>
            <p data-aos="fade-up" className="text-center sm:px-20">
              Download our app for the fastest way to book and manage your vehicle rentals. Enjoy exclusive mobile-only deals, access your booking details anytime, and find the perfect car right from your phone.
            </p>
            <div
              data-aos="fade-up"
